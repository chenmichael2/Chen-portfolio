                            ...
                            <div className="card-content">
                                <div className="content">
                                    ...
                                    <div className="project-button-container">
                                        ...
                                        <a className="button is-link modal-button" href="https://github.com/justinluu8235/viral-api"><i class="fab fa-github need-space"></i>Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card is-shady">
                            ...
                            <div className="card-content">
                                <div className="content">
                                    ...
                                    <div className="project-button-container">
                                        <a className="button is-link modal-button" href="https://github.com/chenmichael2/organize-frontend"><i class="fab fa-github need-space"></i>Front</a>
                                        <a className="button is-link modal-button" href="https://github.com/chenmichael2/organize-back"><i class="fab fa-github need-space"></i>Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
