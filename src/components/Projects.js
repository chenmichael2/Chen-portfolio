                            ...
                            <div className="card-content">
                                <div className="content">
                                    ...
                                    <div className="project-button-container">
                                        <a className="button is-link modal-button" href="https://github.com/chenmichael2/Spaceship-Racer" target="_blank"><i class="fab fa-github"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card is-shady">
                            ...
                            <div className="card-content">
                                <div className="content">
                                    ...
                                    <div className="project-button-container">
                                        <a className="button is-link modal-button" href="https://github.com/cspdevs000/viral-app" target="_blank"><i class="fab fa-github need-space"></i>Front</a>
